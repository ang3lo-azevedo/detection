...
| 16 | **Duck Detector** | DuckDetector | `com.eltavine.duckdetector` | [GitHub](https://github.com/eltavine/Duck-Detector-Refactoring) | ✅ Yes | Root, Hook, Bootloader, SELinux | v2.3 | Apr 2026 | Root, Magisk, KernelSU, APatch, LSPosed, bootloader, SELinux, virtualization |
...
| 18 | **FOSS Root Checker** | FOSS Root Checker (offline) | `foss.chillastro.root.checker` | [GitHub](https://github.com/Chill-Astro/FOSS-Root-Checker) | ✅ Yes | Root Checker | v36.23.2.0 | Apr 2026 | Root access verification (su, `which su`, Magisk SU) |
| 19 | **GarudaDefender** | - | (no package published) | [GitHub](https://github.com/kikyps/GarudaDefender) | ✅ Yes | RASP, Root Detection | v4.8.0 | Jul 2026 | Root, Shamiko, ZygiskNext, Frida, app tampering, debugger detection |
...
| 22 | **Kknd_Root_Detector** | kknd Detector | `com.juanma0511.rootdetector` | [GitHub](https://github.com/juanma0511/Kknd_Root_Detector) | ✅ Yes | Root Detection | v3.1 | May 2026 | 71 native detection functions, SELinux attr/current probe, DirtySepolicy checks, resetprop detection, PIF/TrickyStore config |
| 23 | **Disclosure** | - | `com.disclosure.root` | [Telegram](https://t.me/disclosureofroot) | ❌ Closed Source | Root Detection | v1.2.1 | 2025 | Root detection loopholes, HMA-resistant app detection, SUSFS, SELinux context leak, custom kernel |
...
| 25 | **DirtySepolicy** | - | `org.lsposed.dirtysepolicy` | [GitHub](https://github.com/LSPosed/DirtySepolicy) | ✅ Yes | SELinux Policy Detection | v2.2 | May 2026 | Detects sepolicy patches used by userspace root solutions |
