...
| # | App Name | Aliases | Package Name | Official Links | Open Source | Category | Latest Version (as of Aug 2026) | Last Updated | Detections |
|---|----------|---------|--------------|----------------|-------------|----------|----------------|---------------|-------------|
...
| 2 | **Android Key Attestation (Fork)** | VisionR1 KeyAttestation | (same as above) | [GitHub](https://github.com/VisionR1/KeyAttestation) | ✅ Yes | Bootloader Attestation | v2.0.2(247) | Apr 2026 | Bootloader status, RKP (Remote Key Provisioning) |
| 3 | **Checker** | AkaneChecker | `com.akanet.checker` | [GitHub](https://github.com/FoedusProgramme/Checker) | ✅ Yes | ROM Detection | 1.0.9 | Jan 2026 | Custom ROM identification (MIUI, ColorOS, OneUI, etc.) |
...
| 5 | **Memory Detector** | - | (source and APK in repo) | [GitHub](https://github.com/rushiranpise/detection) | ✅ Yes | Memory-level Root Detection | v2.1.0 | Jan 2025 | Memory scanning for root traces, Magisk, Xposed, virtual environments |
...
| 7 | **Native Detector** | reveny Native Detector | (no standalone package) | [GitHub](https://github.com/reveny/Android-Native-Root-Detector) (library), [Telegram](https://t.me/reveny1) | ✅ Yes | Native Root Detection | v7.7.0 | Apr 2026 | Root, Zygisk, Shamiko, custom ROM, TrickyStore, KernelSU, LSPosed, Abnormal Environment |
...
| 9 | **Ruru** | - | `com.byxiaorun.ruru` | [GitHub](https://github.com/byxiaorun/Ruru) | ✅ Yes | Root, Xposed Detection | v1.1.1 | Jan 2026 | Root, Xposed/LSPosed, Magisk modules, hook detection |
...
| 14 | **Duck Detector** | DuckDetector | `com.eltavine.duckdetector` | [GitHub](https://github.com/eltavine/Duck-Detector-Refactoring) | ✅ Yes | Root, Hook, Bootloader, SELinux | v2.3 | Apr 2026 | Root, Magisk, KernelSU, APatch, LSPosed, bootloader, SELinux, virtualization |
| 15 | **Luna** | Luna检测 | (unknown package) | [Website](https://www.54nb.com/luna/luna.html), [Telegram](https://t.me/chunqiudetector) | ❌ Closed Source | Environment Detection | v1.4.3.5 | 2026 | Root, bootloader, simulator, virtual machine, hardware spoofing |
| 16 | **FOSS Root Checker** | FOSS Root Checker (offline) | `foss.chillastro.root.checker` | [GitHub](https://github.com/Chill-Astro/FOSS-Root-Checker) | ✅ Yes | Root Checker | v36.23.2.0 | Apr 2026 | Root access verification (su, `which su`, Magisk SU) |
| 17 | **GarudaDefender** | - | (no package published) | [GitHub](https://github.com/kikyps/GarudaDefender) | ✅ Yes | RASP, Root Detection | v4.8.0 | Jul 2026 | Root, Shamiko, ZygiskNext, Frida, app tampering, debugger detection |
| 18 | **Demo** | JingMatrix Demo | `com.jingmatrix.demo` | [GitHub](https://github.com/JingMatrix/Demo) | ✅ Yes | Root Detection | v1.11.0 | Jan 2025 | Magisk, KernelSU, APatch detection |
| 19 | **DetectZygisk** | - | `com.apkunpacker.detectzygisk` | [GitHub](https://github.com/apkunpacker/DetectZygisk) | ✅ Yes | Zygisk Detection | v1.0 | 2024 | Zygisk presence detection |
| 20 | **Kknd_Root_Detector** | kknd Detector | `com.juanma0511.rootdetector` | [GitHub](https://github.com/juanma0511/Kknd_Root_Detector) | ✅ Yes | Root Detection | v3.1 | May 2026 | 71 native detection functions, SELinux attr/current probe, DirtySepolicy checks, resetprop detection, PIF/TrickyStore config |
| 21 | **Disclosure** | - | `com.disclosure.root` | [Telegram](https://t.me/disclosureofroot) | ❌ Closed Source | Root Detection | v1.2.1 | 2025 | Root detection loopholes, HMA-resistant app detection, SUSFS, SELinux context leak, custom kernel |
| 22 | **APTest** | - | `com.apkunpacker.aptest` | [GitHub](https://github.com/apkunpacker/MagiskDetection) | ✅ Yes | Magisk Detection | v1.0 | 2024 | Magisk-specific detection |
| 23 | **DirtySepolicy** | - | `org.lsposed.dirtysepolicy` | [GitHub](https://github.com/LSPosed/DirtySepolicy) | ✅ Yes | SELinux Policy Detection | v2.2 | May 2026 | Detects sepolicy patches used by userspace root solutions |
| 24 | **Holmes** | - | `com.apkunpacker.holmes` | [GitHub](https://github.com/apkunpacker/MagiskDetection) | ✅ Yes | Root Detection | v1.5.1 | 2024 | Root, Magisk, Xposed detection |
| 25 | **Xposed Detector** | XposedChecker | `com.godevelopers.XposedChecker` | [Play Store](https://play.google.com/store/apps/details?id=com.godevelopers.XposedChecker) | ✅ Yes | Xposed Framework Detection | v1.1 | 2021 | Xposed framework detection (outdated) |
| 26 | **Applist Detector** | - | `com.tsng.applistdetector` | [GitHub](https://github.com/Dr-TSNG/ApplistDetector) | ✅ Yes | App/Module Detection | v2.4 | Aug 2025 | LSPosed/Xposed modules, suspicious apps (Magisk, etc.), hidden app list bypass |
| 27 | **RootBeerFresh** | - | `com.kimchangyoun.rootbeerFresh.sample` | [GitHub](https://github.com/KimChangYoun/rootbeerFresh), [Play Store](https://play.google.com/store/apps/details?id=com.kimchangyoun.rootbeerFresh.sample) | ✅ Yes | Root Detection Library | v0.0.11 | Sep 2025 | Root, Magisk, Magisk UDS, BusyBox, su binary, build tags, prop checks |
| 28 | **YASNAC** | Yet Another SafetyNet Attestation Checker | `rikka.safetynetchecker` | [GitHub](https://github.com/RikkaW/YASNAC), [Play Store](https://play.google.com/store/apps/details?id=rikka.safetynetchecker) | ✅ Yes | SafetyNet Attestation | v1.2.0 | 2023 | SafetyNet attestation (CTS Profile, Basic Integrity), bootloader unlock, root detection (archived) |
| 29 | **VD-Infos** | VDInfos, VD Info | `com.vitaodoidao.vdinfos` | [GitHub](https://github.com/VD171/VD-Infos), [XDA](https://xdaforums.com/t/app-vd-infos-package-com-vitaodoidao-vdinfos.4097379/) | ✅ Yes | System Info / Root Detection | v1.11-beta6 | Dec 2025 | Root, Magisk, Xposed, LSPosed, Riru, emulators, BusyBox, LuckyPatcher, bootloader, SELinux, device info reader (archived) |
...
|---|----------|---------|--------------|----------------|-------------|----------|----------------|---------------|-------------|
| 30 | **DRM Info** | - | `com.androidfung.drminfo` | [Play Store](https://play.google.com/store/apps/details?id=com.androidfung.drminfo) | ❌ Closed Source | DRM Information | 1.1.18 | Mar 2025 | Widevine DRM level, security level, HDCP capability |
